...
export default function SecaoBeneficiosCorp({ t }: { t: BeneficiosCorpDict }) {
  return (
    <section className="relative bg-primary overflow-hidden">
      ...
      {/* CONTEÚDO */}
      <div className="relative z-10 w-full flex flex-col items-center space-y-15 px-8 pt-32 pb-16">
        ...
        <div className="w-full flex flex-col lg:flex-row justify-between gap-6">
          <div className="lg:w-1/2 flex justify-center">
            <div className="backdrop-blur-md bg-white/10 p-8 border border-white/10 rounded-lg shadow-lg max-w-xl">
