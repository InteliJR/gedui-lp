...
export default function Agendar() {
    ...
    const handleSubmit = (e: React.FormEvent) => {
        ...
        // Example: Redirect to Calendly with pre-filled data
                            ...
                            <div className="space-y-3 py-4">
                                ...
                                <div className="flex items-start gap-3">
                                    ...
                                    >
                                        ...
                                        <span>
                                            Confirmo que li e concordo com os Termos e Condições e autorizo o uso dos
                                            meus dados pessoais para as finalidades descritas na Política de
                                            Privacidade.
                                        </span>
                                    </label>
                                </div>
