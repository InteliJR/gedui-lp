...
export const BLOG_POSTS_PTBR: BlogPostsBySlug = {
    ...
    "inclusao-acessibilidade": {
        ...
        title:
            "Impacto Social Da Educação Tecnológica: Inclusão E Acessibilidade Para Todos",
        excerpt:
    ...
    "transformacao-pedagogia": {
        ...
        title:
            "Tecnologia Na Educação: A Transformação Dos Cursos De Pedagogia E O Papel Da Formação Continuada",
        excerpt:
    ...
    "futuro-escolas": {
        slug: "futuro-escolas",
        title:
            "Ia Na Educação: A Transformação Que Está Redefinindo O Futuro Das Escolas",
        excerpt:
    ...
    "diversidade-inclusao-corporativa": {
        ...
        title:
            "Promovendo A Diversidade E A Inclusão Por Meio Da Educação Corporativa",
        excerpt:
